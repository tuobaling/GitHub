        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    {
                        ...
                        Session.Add("FullName", user.FirstName + " " + user.LastName);
                        Session.Add("ShortName", user.FirstName[0] + "" + user.LastName[0]);
                        ...
                        //ViewBag.Boards = allBoards;
                        //return Redirect("../Boards/Index");
                        //return RedirectToAction("Index", "Home");
                        return RedirectToAction("../Boards/Index");
                        //return View(model);
                    }
                ...
                default:
                    ...
                    return View(model); //  return RedirectToAction("Index", "Home",model);
            }
        }
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    ...
                    // here we can create some roles for different user types
        ...
        public async Task<ActionResult> ExternalLoginCallback(string returnUrl)
        {
            ...
            switch (result)
            {
                ...
                default:
                    ...
                    ViewBag.ReturnUrl = "/Boards/Index";
